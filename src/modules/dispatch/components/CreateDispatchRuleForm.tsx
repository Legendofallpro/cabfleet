 ...
 return (
  <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
   <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
    {/* Priority */}
    <div>
     <label className="mb-1 block text-xs font-medium text-muted dark:text-muted">
      Priority <span className="text-muted">(lower = higher)</span>
     </label>
     <input
      type="number"
      {...register("priority")}
   ...
   <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
    ...
    <div>
     <label className="mb-1 block text-xs font-medium text-muted dark:text-muted">
      Branch <span className="text-muted">(blank = any)</span>
     </label>
     <select
      {...register("branchId")}
      className="w-full rounded-lg border border-default bg-surface-elevated px-3 py-2 text-sm  "
    ...
    <div>
     <label className="mb-1 block text-xs font-medium text-muted dark:text-muted">
      Booking Type <span className="text-muted">(blank = any)</span>
     </label>
     <select
    ...
    <div>
     <label className="mb-1 block text-xs font-medium text-muted dark:text-muted">
      Customer Segment <span className="text-muted">(blank = any)</span>
     </label>
     <input
      type="text"
   ...
   <div className="flex items-center gap-2">
    ...
    />
    <label htmlFor="active" className="text-sm text-muted dark:text-muted">
     Active
    </label>
   </div>
