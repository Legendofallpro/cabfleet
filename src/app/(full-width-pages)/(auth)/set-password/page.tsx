   ...
   <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
    <div className="rounded-2xl border border-default bg-surface-elevated p-6 ">
     ...
     <div className="mt-6 flex flex-col gap-3 sm:flex-row">
      ...
      <Link
       href="/signin"
       className="inline-flex h-10 items-center justify-center rounded-lg border border-default bg-surface-elevated px-4 text-sm text-default hover:bg-surface-inset  "
      >
       Sign in
      </Link>
     </div>
