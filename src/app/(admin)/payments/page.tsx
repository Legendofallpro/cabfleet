    ...
    <div>
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {[
            { label: "Total Revenue", value: "—", color: "bg-success-50 dark:bg-success-500/10" },
            { label: "Pending", value: "—", color: "bg-warning-50 dark:bg-warning-500/10" },
            { label: "Completed", value: "—", color: "bg-brand-50 dark:bg-brand-500/10" },
            { label: "Refunded", value: "—", color: "bg-error-50 dark:bg-error-500/10" },
          ].map((stat) => (
            <div
              key={stat.label}
        ...
        <ComponentCard
          ...
          desc="All payment records will appear here once connected to a data source."
        >
          <div className="flex items-center justify-center py-16 text-gray-400 dark:text-gray-600">
            <p className="text-sm">No data available — connect your payments data source.</p>
          </div>
        </ComponentCard>
      </div>
    </div>
