  ...
  return (
    <div className="relative">
      <button
        ...
        className="dropdown-toggle flex items-center text-default"
      ...
      <Dropdown
        ...
        className="absolute right-0 mt-4 flex w-64 flex-col rounded-2xl border border-default bg-surface-elevated p-3 shadow-theme-lg"
      >
        <div>
          <span className="block font-medium text-caption text-default">
            {user.fullName ?? displayName}
          </span>
          <span className="mt-0.5 block text-caption text-muted">{user.email}</span>
        </div>
...
function ProfileIcon() {
  return (
    <svg
      className="fill-muted group-hover:fill-default"
      width="24"
      height="24"
      viewBox="0 0 24 24"
      fill="none"
